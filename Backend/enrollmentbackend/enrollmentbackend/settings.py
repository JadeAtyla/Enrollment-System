"""
Django settings for enrollmentbackend project.
...
SECRET_KEY = 'django-insecure-kx4ugfxi1+eh3+-xx^p_v5m8)@@t^*@-ejf#k3*z&!ll(3msfd'
...
WSGI_APPLICATION = 'enrollmentbackend.wsgi.application'
