...
const ListOfStudents = ({ onLogout }) => {
    ...
    return (
        <div className="flex min-h-screen">
            ...
            <div className="flex flex-col items-center flex-1 ml-[13.75rem] py-6">
            ...
            {unenrollModal.isOpen && (
                ...
                <div className="bg-white rounded-[1.875rem] p-8 w-[30rem] h-[20rem] shadow-lg">
                  <h2 className="text-xl font-bold mb-4 text-gray-800">
                    Confirm Unenroll
                  </h2>
                  <p className="text-gray-600 mb-4">
                    Enter{" "}
                    <strong className="text-red-600">{unenrollModal.studentId}</strong>{" "}
                    to confirm <span className="text-red-600">Unenroll Student</span>.
                  </p>
                  <input
                    type="text"
                    ...
                    onChange={(e) =>
                      setUnenrollModal({ ...unenrollModal, inputId: e.target.value })
                    }
                  />
                  ...
                  <p className="text-sm text-gray-500 text-left py-3">
                    Note: This action is irreversible and will remove the student from the
                    current list.
                  </p>
                </div>
              </div>
