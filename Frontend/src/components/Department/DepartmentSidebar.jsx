...
const DepartmentSidebar = ({ currentPage, onLogout, onToggleSidebar, isCollapsed }) => {
  ...
  const menuItems = [
    ...
    { name: "enroll", icon: EnrollIcon, label: "Enrollment List", path: "/department/enrollmentList" },
    { name: "list", icon: ListIcon, label: "List of Students", path: "/department/studentList" },
    { name: "account", icon: AccountIcon, label: "Account", path: "/department/account" },
  ];
