...
const InstructorList = ({ onLogout }) => {
  ...
  const handleEnrollment = (studentId) => {
    ...
    navigate("/department/evaluate-student", { state: { student: selectedStudent } });
  };
        ...
        <div className="w-full max-w-[87.5rem] px-6">
          ...
          <div className="bg-white shadow-lg rounded-[1.875rem] p-8">
            <div className="flex justify-between items-center mb-4">
              <h1 className="text-2xl font-semibold text-gray-800">Instructor List</h1>
